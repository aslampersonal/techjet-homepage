...
const TechjetHomePagePage = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-closertext items-center justify-end mx-auto pt-[60px] w-full">
          ...
          <div className="flex flex-col gap-[25px] items-center justify-start mb-24 mt-[31px] w-[96%] md:w-full">
            <div className="flex md:flex-col flex-row md:gap-10 items-end justify-between pt-1.5 w-[97%] md:w-full">
              <Img
                ...
                alt="frame1631"
              />
              <div className="flex sm:flex-col flex-row gap-8 items-center justify-center mb-3 md:mt-0 mt-[15px]">
                <Text
                  className="capitalize text-gray-900 text-xl whitespace-nowrap"
        ...
        <div className="flex flex-col items-center justify-start mt-[200px] w-full">
              ...
              <div className="flex flex-1 flex-col items-center justify-start w-full">
                <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                  <Img
                    ...
                    alt="frame1438"
                  />
                  <div className="flex flex-col gap-[39px] items-start justify-start ml-14 w-full">
              ...
              <div className="flex md:flex-1 flex-col items-center justify-start md:w-full">
                <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                  <Img
                    ...
                    alt="frame1439"
                  />
                  <div className="flex flex-col md:gap-10 gap-[77px] items-start justify-start ml-14 w-full">
                    <div className="flex flex-col gap-6 items-start justify-start w-full">
                      <Text
              ...
              <div className="flex md:flex-1 flex-col items-center justify-start md:w-full">
                <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                  <Img
                    ...
                    alt="frame1440"
                  />
                  <div className="flex flex-col md:gap-10 gap-[62px] items-start justify-start ml-14 w-full">
          ...
          <TechjetHomePageWecater className="flex md:flex-col flex-row md:gap-10 gap-16 items-center justify-start max-w-[1720px] mt-[200px] mx-auto md:px-5 w-full" />
          ...
          <footer className="flex items-center justify-center mt-[200px] md:px-5 w-full">
            <div className="h-[1174px] relative w-full">
              ...
              <div className="bg-yellow-900_02 flex flex-col items-center justify-end mt-[300px] mx-auto p-[30px] sm:px-5 w-full">
